...
from studentPro import settings
from studentApp import views, HodViews, StaffViews, StudentViews
from studentApp.EditResultViewClass import EditResultViewClass
...
urlpatterns = [
    ...
    path('stusent_feedback_message',HodViews.stusent_feedback_message, name='stusent_feedback_message'),
    path('stusent_feedback_replied',HodViews.stusent_feedback_replied, name='stusent_feedback_replied'),
    ...
    path('admin_get_attendance_datas',HodViews.admin_get_attendance_datas, name='admin_get_attendance_datas'),
    ...
    path('get_attendance_datas',StaffViews.get_attendance_datas, name='get_attendance_datas'),
...
# if settings.DEBUG: #يستخدم هذا التضمين لإظهار الملفات من صور وفيديو في المتصفح من قاعدة البيانات
